...
require_once ("/plg_CUSTOM/plg_client_IP.php");
...
function check_client_IP_run_task () {
  ...
  $CSV_file_path = 'allowed_IP.csv'
  
  echo 'User IP Address - '.$_SERVER['REMOTE_ADDR']; 

  #must use abosolute or real path, or the code won't work 
   $file_path = realpath ("TFM_task_router.py");
  ...
  $allowed_client_ips = array(get_allowed_IP($CSV_path)); #must convert the function into array
